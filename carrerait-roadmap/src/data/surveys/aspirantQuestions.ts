export const aspirantQuestions = [
  {
    id: "workStatus",
    question: "¿Estás trabajando?",
    answers: [
      {
        option: "Actualmente, no trabajo.",
        response:
  ...
  {
    id: "workingHours",
    question: "¿Cuántas horas por semana trabajás por lo general?",
    dependsOn: "workStatus",
    showIfWorkStatus: "Sí, trabajo.",
    answers: [
      {
        option: "Entre 10 y 20hs semanales.",
        response:
          "Debido a que trabajás entre 10 y 20hs semanales, seguro tengas tiempo a tu disposición para dedicarle a tus estudios. Esta carga horaria es ideal para ir a la universidad, ya sea presencial y virtual, pero si no está en tus opciones, podés enfocarte en tu formación autodidacta.",
      },
      {
        option: "Entre 20 y 25hs semanales.",
        response:
          "Debido a que trabajás entre 20 y 25hs semanales, seguro tengas algo de tiempo a tu disposición para dedicarle a tus estudios, aunque puede resultarte difícil la organización de tus horarios al principio. Podrías considerar ir a la universidad, ya sea presencial y virtual, pero si no está en tus opciones, podés enfocarte en tu formación autodidacta.",
      },
      {
        option: "Entre 25 y 35hs semanales.",
        response:
      ...
      {
        option: "Entre 35 y 40hs semanales.",
        response:
  ...
  {
    question: "¿Qué pensás de la universidad?",
    answers: [
      {
        option: "Me encanta.",
        response:
      ...
      {
        option: "Me gusta, pero prefiero la modalidad virtual.",
        response:
      ...
      {
        option: "Me gusta, pero prefiero la modalidad presencial.",
        response:
      ...
      {
        option: "La odio. No quiero estudiar en ese tipo de instituciones.",
        response:
  ...
  {
    question: "¿Tenés alguna responsabilidad que te impide estudiar?",
    answers: [
      {
        option:
          "No, no tengo ninguna responsabilidad (que me haga sentir así).",
        response:
      ...
      {
        option: "Problemas personales o familiares.",
        response:
          "Los problemas personales y/o familiares pueden influir bastante a la hora de estudiar. Si estás en una situación que perjudica tu salud mental y/o física, afecta a todos los ámbitos de tu vida, incluyendo el académico. Mi recomendación es que busques la manera de solucionarlos, dependiendo de cuáles sean los inconvenientes. Por ejemplo: si no te sentís bien anímicamente, podrías considerar buscar ayuda profesional. Lo importante es que estés bien, y si eso implica dejar de lado tus estudios por un tiempo, ¡no te preocupes! Es parte del proceso. Espero que logres salir adelante.",
      },
      {
        option: "No consigo organizarme.",
        response:
          "La falta de organización es un problema que muchos atraviesan. Todos tenemos una vida con distintas responsabilidades y obligaciones, y es importante tenerlas en cuenta a la hora de planificar. A su vez, organizarse es cuestión de prueba y error, de ver lo que funciona mejor para vos. Podés fallar al principio, pero lo importante es intentarlo y mejorar.",
      },
    ],
  },
  {
    question: "¿Hiciste/hacés algún bootcamp?",
    answers: [
      {
        option: "Sí, en el pasado.",
        response:
      ...
      {
        option: "No, y no pienso hacer uno.",
        response:
  ...
  {
    question: "¿Estás estudiando actualmente?",
    answers: [
      {
        option: "Sí, estoy en la universidad.",
        response:
      ...
      {
        option: "No, no estoy estudiando nada.",
        response:
      ...
      {
        option: "Sí, estoy haciendo cursos.",
        response:
      ...
      {
        option: "Sí, estudio por mi cuenta.",
        response:
